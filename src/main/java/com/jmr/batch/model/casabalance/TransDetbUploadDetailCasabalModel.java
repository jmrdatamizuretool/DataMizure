...
public class TransDetbUploadDetailCasabalModel {
	...
	public void setRef_rate(String ref_rate) {
	...
	public String getLcy_equivalent() {
		return lcy_equivalent;
	}
	public void setLcy_equivalent(String lcy_equivalent) {
