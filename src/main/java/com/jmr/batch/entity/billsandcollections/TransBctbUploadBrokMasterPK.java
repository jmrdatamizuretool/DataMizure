...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_BROK_MASTER database table.
 * 
 */
@Embeddable
public class TransBctbUploadBrokMasterPK implements Serializable {
	//default serial version id, required for serializable classes.
	    ...
	    public TransBctbUploadBrokMasterPK() {
		}
		...
		public boolean equals(Object other) {
			...
			if (!(other instanceof TransBctbUploadBrokMasterPK)) {
				return false;
			}
			TransBctbUploadBrokMasterPK castOther = (TransBctbUploadBrokMasterPK)other;
			return 
