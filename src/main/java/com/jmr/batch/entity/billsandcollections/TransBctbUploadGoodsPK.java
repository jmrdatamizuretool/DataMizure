 ...
 */
@Embeddable
public class TransBctbUploadGoodsPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadGoodsPK)) {
			return false;
		}
		TransBctbUploadGoodsPK castOther = (TransBctbUploadGoodsPK)other;
		return 
