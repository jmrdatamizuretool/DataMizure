...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_INVOICE_MASTER database table.
 * 
 */
@Embeddable
public class TransBctbUploadInvoiceMasterPK implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	    ...
	    public TransBctbUploadInvoiceMasterPK() {
		}
		...
		public boolean equals(Object other) {
			...
			if (!(other instanceof TransBctbUploadInvoiceMasterPK)) {
				return false;
			}
			TransBctbUploadInvoiceMasterPK castOther = (TransBctbUploadInvoiceMasterPK)other;
			return 
