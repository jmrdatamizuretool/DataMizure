...
/**
 * The primary key class for the TRANS_10 database table.
 * 
 */
@Embeddable
public class TransBctbUploadPayExcPK implements Serializable{
    ...
    public TransBctbUploadPayExcPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadPayExcPK)) {
			return false;
		}
		TransBctbUploadPayExcPK castOther = (TransBctbUploadPayExcPK)other;
		return 
