...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_RESERVE database table.
 * 
 */
@Embeddable
public class TransBctbUploadReservePK implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	    ...
	    public TransBctbUploadReservePK() {
	    }
		...
		public boolean equals(Object other) {
			...
			if (!(other instanceof TransBctbUploadReservePK)) {
				return false;
			}
			TransBctbUploadReservePK castOther = (TransBctbUploadReservePK)other;
			return 
