 ...
 */
@Embeddable
public class TransLctbUploadCollateralPK implements Serializable{
    ...
    public TransLctbUploadCollateralPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransLctbUploadCollateralPK)) {
			return false;
		}
		TransLctbUploadCollateralPK castOther = (TransLctbUploadCollateralPK)other;
		return 
