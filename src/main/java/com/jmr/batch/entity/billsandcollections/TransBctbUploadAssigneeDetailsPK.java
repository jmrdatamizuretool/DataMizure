...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_ASSIGNEE_DETAILS database table.
 * 
 */
@Embeddable
public class TransBctbUploadAssigneeDetailsPK implements Serializable {
    ...
    public TransBctbUploadAssigneeDetailsPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadAssigneeDetailsPK)) {
			return false;
		}
		TransBctbUploadAssigneeDetailsPK castOther = (TransBctbUploadAssigneeDetailsPK)other;
		return 
