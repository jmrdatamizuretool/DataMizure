...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_PARTIES_ADDRESSES database table.
 * 
 */
@Embeddable
public class TransBctbUploadPartiesAddressesPK implements Serializable {
    ...
    public TransBctbUploadPartiesAddressesPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadPartiesAddressesPK)) {
			return false;
		}
		TransBctbUploadPartiesAddressesPK castOther = (TransBctbUploadPartiesAddressesPK)other;
		return 
			...
			&& this.partyType.equals(castOther.partyType)
	...
	public int hashCode() {
		...
		hash = hash * prime + this.partyType.hashCode();
