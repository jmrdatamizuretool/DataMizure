...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_INVOICE_DETAIL database table.
 * 
 */
@Embeddable
public class TransBctbUploadInvoiceDetailPK implements Serializable {
    ...
    public TransBctbUploadInvoiceDetailPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadInvoiceDetailPK)) {
			return false;
		}
		TransBctbUploadInvoiceDetailPK castOther = (TransBctbUploadInvoiceDetailPK)other;
		return 
