...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_DOCS_CLAUSES database table.
 * 
 */
@Embeddable
public class TransBctbUploadDocsClausesPK implements Serializable {
    ...
    public TransBctbUploadDocsClausesPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadDocsClausesPK)) {
			return false;
		}
		TransBctbUploadDocsClausesPK castOther = (TransBctbUploadDocsClausesPK)other;
		return 
			...
			&& this.clauseCode.equals(castOther.clauseCode);
	}
	...
	public int hashCode() {
		...
		hash = hash * prime + this.clauseCode.hashCode();
