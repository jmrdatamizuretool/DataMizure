 ...
 */
@Embeddable
public class TransBctbUploadAccExcPK implements Serializable{
	//default serial version id, required for serializable classes.
	    ...
	    public TransBctbUploadAccExcPK() {
	    }
		...
		public boolean equals(Object other) {
			...
			TransBctbUploadAccExcPK castOther = (TransBctbUploadAccExcPK)other;
			return 
