...
/**
 * The primary key class for the TRANS_BCTB_UPLOAD_DOCS database table.
 * 
 */
@Embeddable
public class TransBctbUploadDocsPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadDocsPK)) {
			return false;
		}
		TransBctbUploadDocsPK castOther = (TransBctbUploadDocsPK)other;
		return 
