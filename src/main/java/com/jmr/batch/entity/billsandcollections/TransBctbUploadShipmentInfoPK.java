 ...
 */
@Embeddable
public class TransBctbUploadShipmentInfoPK implements Serializable{
    ...
    public TransBctbUploadShipmentInfoPK() {
    }
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TransBctbUploadShipmentInfoPK)) {
			return false;
		}
		TransBctbUploadShipmentInfoPK castOther = (TransBctbUploadShipmentInfoPK)other;
		return 
