...
/**
 * The primary key class for the TRANS_ICTM_UPLOAD_TDPAYIN_DET database table.
 * 
 */
@Embeddable
public class TransIctmUploadTdpayinDetPK implements Serializable {
		...
		public TransIctmUploadTdpayinDetPK() {
		...
		public boolean equals(Object other) {
			...
			if (!(other instanceof TransIctmUploadTdpayinDetPK)) {
				return false;
			}
			TransIctmUploadTdpayinDetPK castOther = (TransIctmUploadTdpayinDetPK) other;
