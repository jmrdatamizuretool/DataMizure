...
/**
 * The persistent class for the TRANS_DETB_UPLOAD_MASTER_GLBAL database table.
 * 
 */
@Entity
@Table(name="TRANS_DETB_UPLOAD_MASTER_GLBAL")
public class TransDetbUploadMasterGlbal implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TransDetbUploadMasterGlbalPK id;
	...
	public TransDetbUploadMasterGlbal() {
	}

	public TransDetbUploadMasterGlbalPK getId() {
		return this.id;
	}

	public void setId(TransDetbUploadMasterGlbalPK id) {
		this.id = id;
	}
