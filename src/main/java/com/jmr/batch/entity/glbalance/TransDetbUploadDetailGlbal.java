 ...
 */
@Entity
@Table(name="TRANS_DETB_UPLOAD_DETAIL_GLBAL")
public class TransDetbUploadDetailGlbal implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TransDetbUploadDetailGlbalPK id;
	...
	public TransDetbUploadDetailGlbal() {
	}

	public TransDetbUploadDetailGlbalPK getId() {
		return this.id;
	}

	public void setId(TransDetbUploadDetailGlbalPK id) {
		this.id = id;
	}
