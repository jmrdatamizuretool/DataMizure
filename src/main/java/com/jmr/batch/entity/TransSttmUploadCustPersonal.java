...
@Entity
@Table(name = "TRANS_STTM_UPLOAD_CUST_PERSONAL")
public class TransSttmUploadCustPersonal {
	...
	private Double fax_isd_no;
	private String us_res_status;
	private String pa_issued;
	private String pa_holder_name;
	private String pa_holder_nationalty;
	private String pa_holder_addr;
	private String pa_holder_addr_country;
	private Double pa_holder_tel_isd;
	private String pa_holder_tel_no;
	private String vst_us_prev;
	...
	public String getD_address4() {
		return d_address4;
	}

	public void setD_address4(String d_address4) {
		this.d_address4 = d_address4;
	}
	...
	public Double getFax_isd_no() {
		return fax_isd_no;
	}

	public void setFax_isd_no(Double fax_isd_no) {
	...
	@Column(name = "pa_issued")
	public String getPa_issued() {
		return pa_issued;
	}

	public void setPa_issued(String pa_issued) {
		this.pa_issued = pa_issued;
	}
	@Column(name = "pa_holder_name")
	public String getPa_holder_name() {
		return pa_holder_name;
	}

	public void setPa_holder_name(String pa_holder_name) {
		this.pa_holder_name = pa_holder_name;
	}
	@Column(name = "pa_holder_nationalty")
	public String getPa_holder_nationalty() {
		return pa_holder_nationalty;
	}

	public void setPa_holder_nationalty(String pa_holder_nationalty) {
		this.pa_holder_nationalty = pa_holder_nationalty;
	}
	@Column(name = "pa_holder_addr")
	public String getPa_holder_addr() {
		return pa_holder_addr;
	}

	public void setPa_holder_addr(String pa_holder_addr) {
		this.pa_holder_addr = pa_holder_addr;
	}
	@Column(name = "pa_holder_addr_country")
	public String getPa_holder_addr_country() {
		return pa_holder_addr_country;
	}

	public void setPa_holder_addr_country(String pa_holder_addr_country) {
		this.pa_holder_addr_country = pa_holder_addr_country;
	}

	@Column(name = "pa_holder_tel_isd")
	public Double getPa_holder_tel_isd() {
		return pa_holder_tel_isd;
	}

	public void setPa_holder_tel_isd(Double pa_holder_tel_isd) {
		this.pa_holder_tel_isd = pa_holder_tel_isd;
	}
	@Column(name = "pa_holder_tel_no")
	public String getPa_holder_tel_no() {
		return pa_holder_tel_no;
	}

	public void setPa_holder_tel_no(String pa_holder_tel_no) {
		this.pa_holder_tel_no = pa_holder_tel_no;
	}
	@Column(name = "vst_us_prev")
	public String getVst_us_prev() {
		return vst_us_prev;
	}

	public void setVst_us_prev(String vst_us_prev) {
		this.vst_us_prev = vst_us_prev;
	}
	...
	public TransSttmUploadCustPersonal() {
		super();
	}

	public TransSttmUploadCustPersonal(String customer_prefix, String first_name, String middle_name, String last_name,
			Date date_of_birth, String legal_guardian, String minor, String sex, String p_national_id,
			String passport_no, Date ppt_iss_date, Date ppt_exp_date, String d_address1, String d_address2,
			String d_address3, String telephone, String fax, String e_mail, String p_address1, String p_address3,
			String p_address2, String customer_no, String d_country, String p_country, String resident_status,
			String conversion_status_flag, String err_msg, String maintenance_seq_no, String customer_prefix1,
			String customer_prefix2, Double source_seq_no, String branch_code, String source_code,
			String age_proof_submitted, String p_address4, String d_address4, String place_of_birth,
			String birth_country, Double tel_isd_no, Double mob_isd_no, Double fax_isd_no, String us_res_status,
			String pa_issued, String pa_holder_name, String pa_holder_nationalty, String pa_holder_addr,
			String pa_holder_addr_country, Double pa_holder_tel_isd, String pa_holder_tel_no, String vst_us_prev,
			String mobile_number, String cust_comm_mode, String home_tel_no, Double home_tel_isd, String p_pincode,
			Date pref_contact_dt, Double pref_contact_time, String d_pincode, String mother_maiden_name) {
		super();
		this.customer_prefix = customer_prefix;
		this.first_name = first_name;
		this.middle_name = middle_name;
