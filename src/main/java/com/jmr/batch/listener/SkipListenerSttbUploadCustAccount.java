...
@Component
public class SkipListenerSttbUploadCustAccount {
	@Autowired
	...
	@OnSkipInProcess
	public void skipInProcess(TransSttbUploadCustAccountModel transSttbUploadCustAccountModel, Throwable th) {
		String path = getErrorLog();
		String process_err_path = path + System.getProperty("file.separator") + "SkipInProcess.txt";
		createFile(process_err_path, 
				transSttbUploadCustAccountModel.getMaintenance_seq_no());
	}
	
	
	@OnSkipInWrite
	public void skipInWriter(TransSttbUploadCustAccount transSttbUploadCustAccount, Throwable th) {
		String path = getErrorLog();
		String write_err_path = path + System.getProperty("file.separator") + "SkipInWrite.txt";
		createFile(write_err_path, 
				transSttbUploadCustAccount.getMaintenance_seq_no());
	}
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("STTB_UPLOAD_CUST_ACCOUNT");
