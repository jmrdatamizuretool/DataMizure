...
@Component
public class SkipListenerIctmAccEffdtUpload {
	@Autowired
	...
	@OnSkipInProcess
	public void skipInProcess(TransIctmAccEffdtUploadModel transIctmAccEffdtUploadModel, Throwable th) {
		String path = getErrorLog();
		String process_err_path = path + System.getProperty("file.separator") + "SkipInProcess.txt";
		createFile(process_err_path, 
				transIctmAccEffdtUploadModel.getAcc());
	}
	
	
	@OnSkipInWrite
	public void skipInWriter(TransIctmAccEffdtUpload transIctmAccEffdtUpload, Throwable th) {
		String path = getErrorLog();
		String write_err_path = path + System.getProperty("file.separator") + "SkipInWrite.txt";
		createFile(write_err_path, 
				transIctmAccEffdtUpload.getAcc());
	}
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("ICTM_ACC_EFFDT_UPLOAD");
