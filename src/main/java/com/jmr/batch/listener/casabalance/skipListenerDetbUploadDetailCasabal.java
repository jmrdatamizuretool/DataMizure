...
@Component
public class skipListenerDetbUploadDetailCasabal {
	@Autowired
	...
	@OnSkipInProcess
	public void skipInProcess(TransDetbUploadDetailCasabalModel transDetbUploadDetailCasabalModel, Throwable th) {
		String path = getErrorLog();
		String process_err_path = path + System.getProperty("file.separator") + "SkipInProcess.txt";
		String data = "BRANCH_CODE:\t" + transDetbUploadDetailCasabalModel.getBranch_code() + "\tBRANCH_CODE:" +
		"BATCH_NO:\t" + transDetbUploadDetailCasabalModel.getBatch_no() + "\tBATCH_NO:" +
	...
	@OnSkipInWrite
	public void skipInWriter(TransDetbUploadDetailCasabal transDetbUploadDetailCasabal, Throwable th) {
		String path = getErrorLog();
		...
		/*createFile(write_err_path, 
				transCltbAcUdeUpload.getBranch_code() + ", " + transCltbAcUdeUpload.getEffective_date());*/
		String data = "BRANCH_CODE:\\t" + transDetbUploadDetailCasabal.getId().getBranchCode() + "\t:BRANCH_CODE"
				+ transDetbUploadDetailCasabal.getId().getBatchNo() + "\tBATCH_NO:"
