...
@Component
public class SkipListenerSvtmUploadAccSigDet {
	@Autowired
	...
	@OnSkipInProcess
	public void skipInProcess(TransSvtmUploadAccSigDetModel transSvtmUploadAccSigDetModel, Throwable th) {
		String path = getErrorLog();
		String process_err_path = path + System.getProperty("file.separator") + "SkipInProcess.txt";
		createFile(process_err_path, 
				transSvtmUploadAccSigDetModel.getMaintenance_seq_no());
	}
	
	
	@OnSkipInWrite
	public void skipInWriter(TransSvtmUploadAccSigDet transSvtmUploadAccSigDet, Throwable th) {
		String path = getErrorLog();
		String write_err_path = path + System.getProperty("file.separator") + "SkipInWrite.txt";
		createFile(write_err_path, 
				transSvtmUploadAccSigDet.getMaintenance_seq_no());
	}
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("SVTM_UPLOAD_ACC_SIG_DET");
