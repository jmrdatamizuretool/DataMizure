...
@Component
public class SkipListenerCasaCstmFunctionUserdefFields {
	@Autowired
	...
	@OnSkipInProcess
	public void skipInProcess(TransSttbUploadCustLinkagesModel transSttbUploadCustLinkagesModel, Throwable th) {
		String path = getErrorLog();
		String process_err_path = path + System.getProperty("file.separator") + "SkipInProcess.txt";
		createFile(process_err_path, 
				transSttbUploadCustLinkagesModel.getCust_ac_no());
	}
	
	
	@OnSkipInWrite
	public void skipInWriter(TransSttbUploadCustLinkages transSttbUploadCustLinkages, Throwable th) {
		String path = getErrorLog();
		String write_err_path = path + System.getProperty("file.separator") + "SkipInWrite.txt";
		createFile(write_err_path, 
				transSttbUploadCustLinkages.getCust_ac_no());
	}
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("CASA_CSTM_FUNCTION_USERDEF_FIELDS");
