...
@Component
public class SkipListenerSvtmUploadAccSigMaster {
	 ...
	 @Autowired
		...
		@OnSkipInProcess
		public void skipInProcess(TransSvtmUploadAccSigMasterModel transSvtmUploadAccSigMasterModel, Throwable th) {
			String path = getErrorLog();
			String process_err_path = path + System.getProperty("file.separator") + "SkipInProcess.txt";
			createFile(process_err_path, 
					transSvtmUploadAccSigMasterModel.getAcc_no());
		}
		
		
		@OnSkipInWrite
		public void skipInWriter(TransSvtmUploadAccSigMaster transSvtmUploadAccSigMaster, Throwable th) {
			String path = getErrorLog();
			String write_err_path = path + System.getProperty("file.separator") + "SkipInWrite.txt";
			createFile(write_err_path, 
					transSvtmUploadAccSigMaster.getAcc_no());
		}
		...
		public String getErrorLog() {
			Optional<ErrorLogVb> errorLogVb = repo.findById("SVTM_UPLOAD_ACC_SIG_MASTER");
