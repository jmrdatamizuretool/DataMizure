...
@Component
public class SkipListenerBctbUploadAccFate {
	...
	@OnSkipInProcess
    public void skipInProcess(TransBctbUploadAccFateModel model, Throwable th) {
        String path = getErrorLog();
    ...
    @OnSkipInWrite
    public void skipInWriter(TransBctbUploadAccFate entity, Throwable th) {
        String path = getErrorLog();
        String write_err_path = path + System.getProperty("file.separator") + "SkipInWrite.txt";

        String data = "BRANCH_CODE:\t" + entity.getTransBctbUploadAccFatePK().getBranchCode() + "\tBRANCH_CODE:" +
                      "SOURCE_CODE:\t" + entity.getTransBctbUploadAccFatePK().getSourceCode() + "\tSOURCE_CODE:" +
                      "SOURCE_REF:\t" + entity.getTransBctbUploadAccFatePK().getSourceRef() + "\tSOURCE_REF:" +
                      "SOURCE_SEQ_NO:\t" + entity.getTransBctbUploadAccFatePK().getSourceSeqNo() + "\tSOURCE_SEQ_NO:" +
                      "\tException:" + th.getMessage();
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("BCTB_UPLOAD_ACC_FATE");
