...
@Component
public class SkipListenerBctmUploadLoanPreference {
	...
	@OnSkipInProcess
    public void skipInProcess(TransBctmUploadLoanPreferenceModel model, Throwable th) {
        String path = getErrorLog();
    ...
    @OnSkipInWrite
    public void skipInWriter(TransBctmUploadLoanPreference entity, Throwable th) {
        String path = getErrorLog();
        String writeErrPath = path + System.getProperty("file.separator") + "SkipInWrite.txt";

        String data = "SOURCE_CODE:\t" + entity.getTransBctmUploadLoanPreferencePK().getSourceCode() +
                      "\tBRANCH_CODE:\t" + entity.getTransBctmUploadLoanPreferencePK().getBranchCode() +
                      "\tSOURCE_REF:\t" + entity.getTransBctmUploadLoanPreferencePK().getSourceRef() +
                      "\tSOURCE_SEQ_NO:\t" + entity.getTransBctmUploadLoanPreferencePK().getSourceSeqNo() +
                      "\tException:" + th.getMessage();
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("BCTB_UPLOAD_LOAN_PREFERENCE");
