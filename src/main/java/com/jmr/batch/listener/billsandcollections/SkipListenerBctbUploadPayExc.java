...
@Component
public class SkipListenerBctbUploadPayExc {
	...
	public void skipInRead(Throwable th) {
	 ...
	 @OnSkipInProcess
	    public void skipInProcess(TransBctbUploadPayExcModel model, Throwable th) {
	        String path = getErrorLog();
	    ...
	    @OnSkipInWrite
	    public void skipInWriter(TransBctbUploadPayExc entity, Throwable th) {
	        String path = getErrorLog();
	        String writeErrPath = path + System.getProperty("file.separator") + "SkipInWrite.txt";

	        String data = "SOURCE_CODE:\t" + entity.getTransBctbUploadPayExcPK().getSourceCode() + "\tSOURCE_CODE:" +
	                      "BRANCH_CODE:\t" + entity.getTransBctbUploadPayExcPK().getBranchCode() + "\tBRANCH_CODE:" +
	                      "SOURCE_REF:\t" + entity.getTransBctbUploadPayExcPK().getSourceRef() + "\tSOURCE_REF:" +
	                      "SOURCE_SEQ_NO:\t" + entity.getTransBctbUploadPayExcPK().getSourceSeqNo() + "\tSOURCE_SEQ_NO:" +
	                      "\tException:" + th.getMessage();
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("BCTB_UPLOAD_PAY_EXC");
