...
@Component
public class SkipListenerBctmUploadLoanIccf {
	...
	@OnSkipInProcess
    public void skipInProcess(TransBctmUploadLoanIccfModel model, Throwable th) {
        String path = getErrorLog();
        ...
        String data = "BRANCH_CODE:\t" + model.getBranch_code() + "\tBRANCH_CODE:" +
                      ...
                      "COMPONENT:\t" + model.getComponent() + "\tCOMPONENT:" +
    ...
    @OnSkipInWrite
    public void skipInWriter(TransBctmUploadLoanIccf entity, Throwable th) {
        String path = getErrorLog();
        String writeErrPath = path + System.getProperty("file.separator") + "SkipInWrite.txt";

        String data = "BRANCH_CODE:\t" + entity.getTransBctmUploadLoanIccfPK().getBranchCode() + "\tBRANCH_CODE:" +
                      "SOURCE_CODE:\t" + entity.getTransBctmUploadLoanIccfPK().getSourceCode() + "\tSOURCE_CODE:" +
                      "SOURCE_REF:\t" + entity.getTransBctmUploadLoanIccfPK().getSourceRef() + "\tSOURCE_REF:" +
                      "SOURCE_SEQ_NO:\t" + entity.getTransBctmUploadLoanIccfPK().getSourceSeqNo() + "\tSOURCE_SEQ_NO:" +
                      "COMPONENT:\t" + entity.getTransBctmUploadLoanIccfPK().getComponent() + "\tCOMPONENT:" +
                      "\tException:" + th.getMessage();
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("BCTM_UPLOAD_LOAN_ICCF");
