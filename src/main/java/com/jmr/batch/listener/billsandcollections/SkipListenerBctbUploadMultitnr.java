...
@Component
public class SkipListenerBctbUploadMultitnr {
	...
	@OnSkipInProcess
    public void skipInProcess(TransBctbUploadMultitnrModel model, Throwable th) {
        String path = getErrorLog();
        ...
        String data =
                ...
                "\tSERIAL_NUMBER:\t" + model.getSerial_number() +
    ...
    @OnSkipInWrite
    public void skipInWriter(TransBctbUploadMultitnr entity, Throwable th) {
        String path = getErrorLog();
        String writeErrPath = path + System.getProperty("file.separator") + "SkipInWrite.txt";

        String data =
                "SOURCE_CODE:\t" + entity.getTransBctbUploadMultitnrPK().getSourceCode() +
                "\tBRANCH_CODE:\t" + entity.getTransBctbUploadMultitnrPK().getBranchCode() +
                "\tSOURCE_REF:\t" + entity.getTransBctbUploadMultitnrPK().getSourceRef() +
                "\tSOURCE_SEQ_NO:\t" + entity.getTransBctbUploadMultitnrPK().getSourceSeqNo() +
                "\tSERIAL_NUMBER:\t" + entity.getTransBctbUploadMultitnrPK().getSerialNumber() +
                "\tException:" + th.getMessage();
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("BCTB_UPLOAD_INVOICE_DETAIL");
