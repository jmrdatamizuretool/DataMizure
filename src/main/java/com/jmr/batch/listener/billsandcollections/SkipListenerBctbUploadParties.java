...
public class SkipListenerBctbUploadParties {
    ...
    public void onSkipInRead(Throwable t) {
        if (t instanceof FlatFileParseException) {
            ...
            writeToFile("SkipInRead_Parties.txt", data);
        }
    }

    @OnSkipInProcess
    public void onSkipInProcess(TransBctbUploadPartiesModel model, Throwable t) {
        String data = "PROCESS SKIPPED: BRANCH_CODE=" + model.getBranch_code() +
                      ...
                      ", ERROR=" + t.getMessage();
        writeToFile("SkipInProcess_Parties.txt", data);
    }

    @OnSkipInWrite
    public void onSkipInWrite(TransBctbUploadParties entity, Throwable t) {
        String data = "WRITE SKIPPED: BRANCH_CODE=" + entity.getId().getBranchCode() +
                      ...
                      ", ERROR=" + t.getMessage();
        writeToFile("SkipInWrite_Parties.txt", data);
    }
    ...
    private String getLogPath() {
        Optional<ErrorLogVb> errorLogVb = errorLogRepository.findById("BCTB_UPLOAD_PARTIES");
