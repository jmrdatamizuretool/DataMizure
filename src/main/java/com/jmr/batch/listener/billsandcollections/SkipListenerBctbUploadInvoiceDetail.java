...
public class SkipListenerBctbUploadInvoiceDetail {
	...
	public void skipInRead(Throwable th) {
	 ...
	 @OnSkipInProcess
	    public void skipInProcess(TransBctbUploadInvoiceDetailModel model, Throwable th) {
	        String path = getErrorLog();
	    ...
	    @OnSkipInWrite
	    public void skipInWriter(TransBctbUploadInvoiceDetail entity, Throwable th) {
	        String path = getErrorLog();
	        String writeErrPath = path + System.getProperty("file.separator") + "SkipInWrite.txt";

	        String data =
	            "SOURCE_CODE:\t" + entity.getTransBctbUploadInvoiceDetailPK().getSourceCode() + "\tSOURCE_CODE:" +
	            "BRANCH_CODE:\t" + entity.getTransBctbUploadInvoiceDetailPK().getBranchCode() + "\tBRANCH_CODE:" +
	            "SOURCE_REF:\t" + entity.getTransBctbUploadInvoiceDetailPK().getSourceRef() + "\tSOURCE_REF:" +
	            "SOURCE_SEQ_NO:\t" + entity.getTransBctbUploadInvoiceDetailPK().getSourceSeqNo() + "\tSOURCE_SEQ_NO:" +
	            "\tException:" + th.getMessage();
