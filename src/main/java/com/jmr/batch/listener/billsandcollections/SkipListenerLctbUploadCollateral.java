...
@Component
public class SkipListenerLctbUploadCollateral {
	...
	@OnSkipInProcess
    public void skipInProcess(TransLctbUploadCollateralModel model, Throwable th) {
        String path = getErrorLog();
    ...
    @OnSkipInWrite
    public void skipInWriter(TransLctbUploadCollateral entity, Throwable th) {
        String path = getErrorLog();
        String writeErrPath = path + System.getProperty("file.separator") + "SkipInWrite.txt";

        String data = "SOURCE_CODE:\t" + entity.getTransLctbUploadCollateralPK().getSourceCode() +
                      "\tBRANCH_CODE:\t" + entity.getTransLctbUploadCollateralPK().getBranchCode() +
                      "\tSOURCE_REF:\t" + entity.getTransLctbUploadCollateralPK().getSourceRef() +
                      "\tSOURCE_SEQ_NO:\t" + entity.getTransLctbUploadCollateralPK().getSourceSeqNo() +
                      "\tException:" + th.getMessage();
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("LCTB_UPLOAD_COLLATERAL");
