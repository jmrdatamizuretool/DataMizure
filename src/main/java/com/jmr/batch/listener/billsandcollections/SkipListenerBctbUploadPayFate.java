...
@Component
public class SkipListenerBctbUploadPayFate {
	...
	@OnSkipInProcess
    public void skipInProcess(TransBctbUploadPayFateModel model, Throwable th) {
        String path = getErrorLog();
    ...
    @OnSkipInWrite
    public void skipInWriter(TransBctbUploadPayFate entity, Throwable th) {
        String path = getErrorLog();
        String writeErrPath = path + System.getProperty("file.separator") + "SkipInWrite.txt";

        String data = "SOURCE_CODE:\t" + entity.getTransBctbUploadPayFatePK().getSourceCode() + "\tSOURCE_CODE:" +
                      "BRANCH_CODE:\t" + entity.getTransBctbUploadPayFatePK().getBranchCode() + "\tBRANCH_CODE:" +
                      "SOURCE_REF:\t" + entity.getTransBctbUploadPayFatePK().getSourceRef() + "\tSOURCE_REF:" +
                      "SOURCE_SEQ_NO:\t" + entity.getTransBctbUploadPayFatePK().getSourceSeqNo() + "\tSOURCE_SEQ_NO:" +
                      "\tException:" + th.getMessage();
	...
	public String getErrorLog() {
		Optional<ErrorLogVb> errorLogVb = repo.findById("BCTB_UPLOAD_PAY_FATE");
