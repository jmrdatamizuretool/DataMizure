...
@Component
public class SkipListenerBctbUploadPartiesAddresses {
	...
	@OnSkipInProcess
    public void skipInProcess(TransBctbUploadPartiesAddressesModel model, Throwable th) {
        String path = getErrorLog();
        ...
        String data = "SOURCE_CODE:\t" + model.getSource_code() + "\tSOURCE_CODE:" +
                      ...
                      "PARTY_TYPE:\t" + model.getParty_type() + "\tPARTY_TYPE:" +
    ...
    @OnSkipInWrite
    public void skipInWriter(TransBctbUploadPartiesAddresses entity, Throwable th) {
        String path = getErrorLog();
        String write_err_path = path + System.getProperty("file.separator") + "SkipInWrite.txt";

        String data = "SOURCE_CODE:\t" + entity.getTransBctbUploadPartiesAddressesPK().getSourceCode() + "\tSOURCE_CODE:" +
                      "BRANCH_CODE:\t" + entity.getTransBctbUploadPartiesAddressesPK().getBranchCode() + "\tBRANCH_CODE:" +
                      "SOURCE_REF:\t" + entity.getTransBctbUploadPartiesAddressesPK().getSourceRef() + "\tSOURCE_REF:" +
                      "PARTY_TYPE:\t" + entity.getTransBctbUploadPartiesAddressesPK().getPartyType() + "\tPARTY_TYPE:" +
                      "MEDIA:\t" + entity.getTransBctbUploadPartiesAddressesPK().getMedia() + "\tMEDIA:" +
                      "SOURCE_SEQ_NO:\t" + entity.getTransBctbUploadPartiesAddressesPK().getSourceSeqNo() + "\tSOURCE_SEQ_NO:" +
